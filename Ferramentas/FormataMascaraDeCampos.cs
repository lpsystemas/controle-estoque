...
namespace Ferramentas
{
    ...
    {
        public static void FormataMascaraCampoCpfCnpj(
            CampoParaFormatacao campo,
            TextBox valorCampoCpfCnpj)
        {
            switch (campo)
            {
        ...
        public static void FormataMascaraTelefone(
            CampoParaFormatacao campo,
            TextBox valorCampoTelefone)
        {
        ...
        public static void FormataMascaraCEP(
            CampoParaFormatacao campo,
            TextBox ValorCampoCEP)
        {
