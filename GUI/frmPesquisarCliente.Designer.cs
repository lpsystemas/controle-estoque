...
namespace GUI
{
  partial class frmPesquisarCliente
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.rbCnpjCliente.CheckedChanged += new System.EventHandler(this.txtValorPesquisaCliente_TextChanged);
      // 
      // rbCpfCliente
      // 
      ...
      this.rbCpfCliente.CheckedChanged += new System.EventHandler(this.txtValorPesquisaCliente_TextChanged);
      // 
      // rbNomeCliente
      // 
      ...
      this.rbNomeCliente.CheckedChanged += new System.EventHandler(this.txtValorPesquisaCliente_TextChanged);
      // 
      // frmPesquisarCliente
      // 
